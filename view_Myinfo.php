...
session_start();
if ($_SESSION['logged_as'] == 'Admin' && !isset($_SESSION['user_id'])) {
        ...
        <body class="flex-column text-center justify-content-center align-items-center vh-100 bg-light" data-new-gr-c-s-check-loaded="14.1001.0" data-gr-ext-installed="">
            ...
            <center>
                <div class="signup-form bg-light" style="width: 50%;">
                    <form class="p-4 mb-3" action="update_info.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
                        <!-- <h2 class="mb-3">School Tap ID System</h2> -->
                        <h2 class="mb-3">My Information</h2>
                        <div class="form-group mb-3">
                            <div class="row">
                                <div class="col"><input type="text" class="form-control" name="first_name" value="<?php echo $first_name; ?>" placeholder="First Name" required="required" readonly></div>
                                <div class="col"><input type="text" class="form-control" name="last_name" value="<?php echo $last_name; ?>" placeholder="Last Name" required="required" readonly></div>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <?php
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="password" class="form-control" name="old_password" placeholder="Password" <?php echo $password; ?>>
                        </div>
                        <div class="form-group mb-3">
                            <label for="new_password">New Password</label>

                            <input type="password" class="form-control" name="new_password" placeholder="Confirm Password" <?php echo $password; ?>>
                        </div>
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" name="course" value="<?php echo $course; ?>" placeholder="Course" readonly>
                        </div>
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" name="section" value="<?php echo $section; ?>" placeholder="Section" readonly>
                        </div>
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" name="year" value="<?php echo $year; ?>" placeholder="Year" readonly>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <select name="subjects[]" id="subjects" multiple class="form-control" readonly>
                        ...
                        $.ajax({
                            ...
                            success: function(source) {
                                ...
                                jQuery.each(source, function(index, item) {
                                    ...
                                    $('#subjects ').append("<option value='" + myValue + "' selected>" + myValue + "</option>");
                                });
