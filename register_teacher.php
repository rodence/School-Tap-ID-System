                ...
                foreach ($selected_subjects as $subject) {
                    ...
                    if (!$result) {
                        echo '
                                        ...
                                        <script>window.location.href = "../register_teacher.php"</script>
                                    ';
                        // exit;
                    }
                }
    ...
    <body class="flex-column text-center justify-content-center align-items-center vh-100 bg-light" data-new-gr-c-s-check-loaded="14.1001.0" data-gr-ext-installed="">
        ...
        <center>
            <div class="signup-form bg-light" style="width: 50%;">
                <form class="p-4 mb-3" action="register_teacher.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
                    <!-- <h2 class="mb-3">School Tap ID System</h2> -->
                    <h2 class="mb-3">Teacher Register</h2>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label for="id" style="display: inline-block; width: 100px; text-align: right !important;">Teacher ID:</label>
